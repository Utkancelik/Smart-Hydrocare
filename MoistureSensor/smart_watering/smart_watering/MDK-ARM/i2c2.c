...
/* I2C Handle */
I2C_HandleTypeDef myI2Chandle_1;
...
static void I2C_Config(void)
{
	...
	myI2Chandle_1.Instance = I2C2;
	myI2Chandle_1.Init.AddressingMode = I2C_ADDRESSINGMODE_7BIT;
	myI2Chandle_1.Init.ClockSpeed = 100000;
	myI2Chandle_1.Init.DualAddressMode = I2C_DUALADDRESS_DISABLED;
	myI2Chandle_1.Init.DutyCycle = I2C_DUTYCYCLE_2;
	myI2Chandle_1.Init.GeneralCallMode = I2C_GENERALCALL_DISABLED;
	myI2Chandle_1.Init.NoStretchMode = I2C_NOSTRETCH_DISABLED;
	myI2Chandle_1.Init.OwnAddress1 = 0;
	myI2Chandle_1.Init.OwnAddress2 = 0;
	HAL_I2C_Init(&myI2Chandle_1);
}
/**********************************************************************************/
 ...
 * @retval None
 */
void LCD_Send_Cmd_1(uint8_t cmd)
{
	...
	if(HAL_I2C_IsDeviceReady(& myI2Chandle_1, I2C_SLAVE_ADDRESS, 1, 10) == HAL_OK)
		HAL_I2C_Master_Transmit(& myI2Chandle_1,I2C_SLAVE_ADDRESS, data_u_tx, 2, 100); 
	...
	if(HAL_I2C_IsDeviceReady(& myI2Chandle_1, I2C_SLAVE_ADDRESS, 1, 10) == HAL_OK)
		HAL_I2C_Master_Transmit(& myI2Chandle_1,I2C_SLAVE_ADDRESS, data_l_tx, 2, 100);	
 ...
 * @retval None
 */
void LCD_Send_Data_1(uint8_t data)
{
	uint8_t data_u, data_l;
	uint8_t data_u_tx[2], data_l_tx[2];
...
void LCD_Init_1(void)
{
	...
	LCD_Send_Cmd_1(LCD_FUNCTION_SET1);
	
	/*Function Set -As per HD44780U*/
	LCD_Send_Cmd_1(LCD_FUNCTION_SET2);
	
	/*Set 4bit mode and 2 lines */
	LCD_Send_Cmd_1(LCD_4BIT_2LINE_MODE);
 ...
 * @retval None
 */
void LCD_Send_String_1(char *str)
{
	while (*str)  
	{
		LCD_Send_Data_1(*str++);
 ...
 * @retval None
 */
void LCD_Clear_Then_Display_1(char *str)
{
	LCD_Send_Cmd_1(LCD_CLEAR_DISPLAY);
	LCD_Send_String_1(str);
}
 ...
 * @retval None
 */
void LCD_Send_String_On_Line1_1(char *str)
{
 ...
 * @retval None
 */
void LCD_Send_String_On_Line2_1(char *str)
{
 ...
 * @retval None
 */
void LCD_Display_Long_Message_1(char *string)
{
	int i =0, count =1, j=0;
